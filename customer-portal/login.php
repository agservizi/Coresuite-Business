...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-DlN1pu2nSBZLSmwXpoftlWxzeFogj73pvjmHyq9S5YGdt0JdREVQ9JxT4X0x4s6wckkx2afrwB6K2d6c8K+f9g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        ...
        <main class="login-panel" role="main">
            <div class="login-panel-inner">
                ...
                <section id="loading" class="login-step login-loading" aria-live="polite">
                    ...
                    <p class="mt-3 text-muted">Elaborazione in corso. Attendere qualche istante...</p>
                </section>
