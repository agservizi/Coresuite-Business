...
$smsEnabled = (bool) portal_config('enable_sms');
...
<div class="portal-main">
    ...
    <main class="portal-content">
        <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3 mb-4">
            ...
            <a class="btn btn-outline-secondary" href="profile.php"><i class="fa-solid fa-id-card me-2"></i>Profilo account</a>
        </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="settings.php" class="vstack gap-4">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" id="notification-sms" name="notification_sms" type="checkbox" value="1" <?= !empty($preferences['notification_sms']) ? 'checked' : '' ?> <?= $smsEnabled ? '' : 'disabled' ?>>
                                <label class="form-check-label fw-semibold" for="notification-sms">SMS</label>
                                <p class="text-muted small mb-0">
                                    <?php if ($smsEnabled): ?>
                                        Ti invieremo un messaggio al numero <?= htmlspecialchars($customer['phone'] ?? 'non specificato') ?>.
                                    <?php else: ?>
                                        Servizio attualmente non disponibile sul tuo contratto.
                                    <?php endif; ?>
                                </p>
                                <?php if (!$smsEnabled): ?>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                <span><i class="fa-solid fa-mobile-screen-button text-primary me-2"></i>SMS</span>
                                <span class="badge <?= $smsEnabled && !empty($preferences['notification_sms']) ? 'bg-success' : 'bg-secondary' ?>">
                                    <?= $smsEnabled && !empty($preferences['notification_sms']) ? 'Attivo' : 'Disattivo' ?>
                                </span>
                            </li>
