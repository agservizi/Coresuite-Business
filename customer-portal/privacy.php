        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <section class="mb-5">
                    ...
                    <p class="mb-0">Per ogni chiarimento puoi consultare la <a href="https://www.agenziaplinio.it/privacy-policy" target="_blank" rel="noopener">Privacy Policy ufficiale di AG Servizi</a> oppure contattarci tramite i riferimenti indicati al paragrafo 9.</p>
                </section>
                ...
                <section class="mb-5">
                    ...
                    <ul class="mb-0">
                        ...
                        <li><strong>Dati operativi delle spedizioni</strong>: codici di tracking, corriere selezionato, destinatario, note operative, punto di ritiro e stato del pacco.</li>
                ...
                <section class="mb-5">
                    <h2 class="h5 mb-3">4. Basi giuridiche</h2>
                ...
                <section class="mb-5">
                    <h2 class="h5 mb-3">5. Periodo di conservazione</h2>
                ...
                <section class="mb-5">
                    <h2 class="h5 mb-3">6. Destinatari e trasferimenti</h2>
                    ...
                    <ul>
                        ...
                        <li>partner logistici e corrieri nazionali/internazionali coinvolti nella gestione delle spedizioni;</li>
                ...
                <section class="mb-5">
                    <h2 class="h5 mb-3">8. Misure di sicurezza</h2>
                ...
                <section class="mb-5">
                    <h2 class="h5 mb-3">9. Contatti dedicati alla privacy</h2>
                ...
                <section>
                    <h2 class="h5 mb-3">10. Aggiornamenti dell'informativa</h2>
