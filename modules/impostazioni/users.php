...
$allowedRoles = ['Admin', 'Manager', 'Operatore', 'Cliente'];
                ...
                <div class="card ag-card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="role" name="role">
                                    <?php foreach ($allowedRoles as $roleOption): ?>
                                        <option value="<?php echo $roleOption; ?>" <?php echo $createData['role'] === $roleOption ? 'selected' : ''; ?>><?php echo $roleOption; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="text-end">
                                <button class="btn btn-warning text-dark" type="submit"><i class="fa-solid fa-user-plus me-2"></i>Crea utente</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <table class="table table-dark table-hover mb-0 align-middle">
                                ...
                                <?php foreach ($users as $user): ?>
                                    ...
                                    <tr id="user-row-<?php echo (int) $user['id']; ?>">
                                        ...
                                        <td><span class="badge ag-badge"><?php echo sanitize_output($user['ruolo']); ?></span></td>
                                        ...
                                        <td class="text-end">
                                            <button class="btn btn-sm btn-outline-warning me-2" type="button"
                                            ...
                                            <?php if (!$isCurrentUser): ?>
                                                <form method="post" class="d-inline" onsubmit="return confirm('Eliminare questo utente?');">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-danger" type="submit"><i class="fa-solid fa-user-minus"></i></button>
                                                </form>
                                            <?php else: ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-footer border-0">
                ...
                <button type="submit" form="editUserForm" class="btn btn-warning text-dark">Salva modifiche</button>
            </div>
        </div>
    </div>
</div>
