    ...
    <main class="content-wrapper">
        <div class="page-toolbar mb-4">
            ...
            <div class="toolbar-actions d-flex gap-2">
                ...
                <a class="btn btn-outline-warning" href="https://www.anpr.interno.it/portale/web/guest/accesso-ai-servizi" target="_blank" rel="noopener"><i class="fa-solid fa-up-right-from-square me-2"></i>Portale ANPR</a>
            </div>
        </div>
