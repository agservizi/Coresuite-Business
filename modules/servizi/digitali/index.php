                        ...
                        <tbody>
                            <?php foreach ($movements as $movement): ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group">
                                            <a class="btn btn-sm btn-outline-warning" href="view.php?id=<?php echo (int) $movement['id']; ?>"><i class="fa-solid fa-eye"></i></a>
                                            <a class="btn btn-sm btn-outline-warning" href="edit.php?id=<?php echo (int) $movement['id']; ?>"><i class="fa-solid fa-pen"></i></a>
