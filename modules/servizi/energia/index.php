                            ...
                            <tbody>
                                <?php foreach ($contracts as $contract): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $count = (int) ($contract['attachments_count'] ?? 0); ?>
                                            <?php if ($count > 0): ?>
                                        ...
                                        <td class="text-end">
                                            <div class="btn-group" role="group">
                                                <a class="btn btn-sm btn-outline-warning" href="view.php?id=<?php echo (int) $contract['id']; ?>" title="Dettagli"><i class="fa-solid fa-eye"></i></a>
                                                <form method="post" class="d-inline">
                                                    <input type="hidden" name="_token" value="<?php echo sanitize_output($csrfToken); ?>">
                                                    <input type="hidden" name="id" value="<?php echo (int) $contract['id']; ?>">
                                                    <input type="hidden" name="action" value="send_email">
                                                    <button class="btn btn-sm btn-outline-warning" type="submit" title="Invia email" <?php echo !empty($contract['email_sent_at']) ? 'disabled' : ''; ?>>
                                                ...
                                                <form method="post" class="d-inline">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-warning" type="submit" title="Invia reminder" <?php echo empty($contract['email_sent_at']) ? 'disabled' : ''; ?>>
