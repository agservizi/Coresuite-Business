                    ...
                    <table class="table table-dark table-hover" data-datatable="true">
                        ...
                        <?php foreach ($projects as $project): ?>
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        <a class="btn btn-sm btn-outline-warning" href="view.php?id=<?php echo (int) $project['id']; ?>"><i class="fa-solid fa-eye"></i></a>
                                        <a class="btn btn-sm btn-outline-warning" href="edit.php?id=<?php echo (int) $project['id']; ?>"><i class="fa-solid fa-pen"></i></a>
