...
if (strcasecmp((string) ($appointment['stato'] ?? ''), GoogleCalendarService::CONFIRMED_STATUS) !== 0) {
    add_flash('warning', 'Sincronizza l\'appuntamento solo dopo averlo impostato come "Confermato".');
    header('Location: view.php?id=' . $id);
    exit;
}
