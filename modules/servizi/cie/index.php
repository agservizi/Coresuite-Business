    ...
    <main class="content-wrapper">
        <div class="page-toolbar mb-4 d-flex justify-content-between align-items-start flex-wrap gap-3">
            ...
            <div class="toolbar-actions d-flex gap-2">
                <a class="btn btn-outline-warning" href="https://www.prenotazionicie.interno.gov.it/cittadino/n/sc/wizardAppuntamentoCittadino/sceltaComune" target="_blank" rel="noopener"><i class="fa-solid fa-list me-2"></i>Catalogo servizi</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="btn-group" role="group">
                                                <a class="btn btn-sm btn-outline-warning" href="view.php?id=<?php echo (int) $booking['id']; ?>" title="Dettagli"><i class="fa-solid fa-eye"></i></a>
                                                <a class="btn btn-sm btn-outline-warning" href="edit.php?id=<?php echo (int) $booking['id']; ?>" title="Modifica"><i class="fa-solid fa-pen"></i></a>
                                                <a class="btn btn-sm btn-outline-warning" href="open_portal.php?id=<?php echo (int) $booking['id']; ?>" title="Apri portale" target="_blank"><i class="fa-solid fa-up-right-from-square"></i></a>
                                                <a class="btn btn-sm btn-outline-danger" href="delete.php?id=<?php echo (int) $booking['id']; ?>" title="Elimina"><i class="fa-solid fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
