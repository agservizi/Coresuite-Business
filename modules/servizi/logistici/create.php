...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        $stmt = $pdo->prepare('INSERT INTO spedizioni (cliente_id, tipo_spedizione, mittente, destinatario, tracking_number, stato, note) VALUES (:cliente_id, :tipo_spedizione, :mittente, :destinatario, :tracking_number, :stato, :note)');
        $stmt->execute([
