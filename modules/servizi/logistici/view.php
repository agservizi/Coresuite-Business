...
$pageTitle = 'Dettaglio spedizione';
...
<div class="flex-grow-1 d-flex flex-column min-vh-100">
    ...
    <main class="content-wrapper">
        <div class="page-toolbar mb-4">
            <a class="btn btn-outline-warning" href="index.php"><i class="fa-solid fa-arrow-left"></i> Tutte le spedizioni</a>
            ...
            <div class="col-md-6">
                <div class="card ag-card h-100">
                    <div class="card-header bg-transparent border-0">
                        <h5 class="card-title mb-0">Dettagli spedizione</h5>
                    </div>
                    <div class="card-body">
                        <dl class="row mb-0">
